...
export function Hero() {
  return (
   <section className="px-4 pt-8 sm:px-6 sm:pt-10 lg:px-8">
     <div className="mx-auto max-w-360 border border-border bg-surface">
 ...
 <div className="bg-surface-tertiary px-4 pt-7 sm:px-8 lg:px-10">
   <div className="landing-browser-frame landing-browser-shadow mx-auto max-w-278.5 overflow-hidden rounded-[26px] bg-surface">
    <Image
