...
export function Features() {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8">
      <div className="landing-panel landing-grid mx-auto grid max-w-360 overflow-hidden lg:grid-cols-[1.02fr_1fr]">
        <div className="bg-surface-tertiary px-6 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-16">
          <div className="mx-auto max-w-147.5 overflow-hidden rounded-[28px] border border-border bg-surface">
            <Image
              src="/agnet-log.png"
